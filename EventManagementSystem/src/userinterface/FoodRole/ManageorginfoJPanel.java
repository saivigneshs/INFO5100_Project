...
public class ManageorginfoJPanel extends javax.swing.JPanel {
    ...
    public ManageorginfoJPanel(JPanel container, UserAccount account, EcoSystem system,Network network) {
        initComponents();
...
private void disableEdit(){
    ...
    private void initComponents() {
        ...
        add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 80, -1, -1));
        ...
        for (Network n : system.getNetworkList()) {
                    for (Enterprise e : n.getEnterpriseDirectory().getEnterpriseList()) {
                        for (Organization org : e.getOrganizationDirectory().getOrganizationList()) {
                            if(org.getType().equals(Organization.Type.Food)){
