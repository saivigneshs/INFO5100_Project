 ...
 */
public class AddPhotographerJPanel extends javax.swing.JPanel {
    ...
    public AddPhotographerJPanel(JPanel userProcessContainer, UserAccount account, EcoSystem system) {
        initComponents();
