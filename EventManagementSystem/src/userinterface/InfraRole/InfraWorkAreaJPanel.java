...
public class InfraWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void manageRequests(){
        InfraRequestJPanel infraRequestJPanel = new InfraRequestJPanel(rightPanel,userAccount,system);
        rightPanel.add("infraRequestJPanel",infraRequestJPanel);
        CardLayout layout = (CardLayout) rightPanel.getLayout();
        layout.next(rightPanel);
    }
    ...
    private void initComponents() {
        ...
        title2.setText("Infra Team Details");
