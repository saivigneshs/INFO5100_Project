...
public class GovtAdminWorkAreaJPanel extends javax.swing.JPanel {
     ...
     * @param network
     */
    public GovtAdminWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Network network, EcoSystem business) {
        initComponents();
    ...
    private void manageOrganization() {
        GovtManageOrgJPanel GovtManageOrgJPanel = new GovtManageOrgJPanel(enterprise.getOrganizationDirectory());
        workAreaPanel.add("GovtManageOrgJPanel", GovtManageOrgJPanel);
        CardLayout layout = (CardLayout) workAreaPanel.getLayout();
        layout.next(workAreaPanel);
    }

    private void manageEmployee() {
        GovtManageEmpJPanel GovtManageEmpJPanel = new GovtManageEmpJPanel(enterprise.getOrganizationDirectory());
        workAreaPanel.add("GovtManageEmpJPanel", GovtManageEmpJPanel);
        CardLayout layout = (CardLayout) workAreaPanel.getLayout();
        layout.next(workAreaPanel);
    }

    private void manageUsers() {
        GovtManageUsersJPanel GovtManageUsersJPanel = new GovtManageUsersJPanel(enterprise, system, organization);
        workAreaPanel.add("GovtManageUsersJPanel", GovtManageUsersJPanel);
        CardLayout layout = (CardLayout) workAreaPanel.getLayout();
        layout.next(workAreaPanel);
    }

    private void manageRequests() {
        GovtManageWorkReqsJPanel GovtManageWorkReqsJPanel = new GovtManageWorkReqsJPanel(enterprise);
        workAreaPanel.add("GovtManageWorkReqsJPanel", GovtManageWorkReqsJPanel);
        CardLayout layout = (CardLayout) workAreaPanel.getLayout();
        layout.next(workAreaPanel);
    }
    ...
    private void initComponents() {
        ...
        menuPanel.add(manageOrgPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 260, 40));
        ...
        menuPanel.add(manageEmp, new org.netbeans.lib.awtextra.AbsoluteConstraints(16, 140, 250, 40));
        ...
        manageUserAccLayout.setHorizontalGroup(
            ...
            .addGroup(manageUserAccLayout.createSequentialGroup()
                .addGap(62, 62, 62)
                .addComponent(manageUserAccountLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        lblHeading.setText("Government Authority Work Area");
        menuPanel.add(lblHeading, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, -1, -1));
