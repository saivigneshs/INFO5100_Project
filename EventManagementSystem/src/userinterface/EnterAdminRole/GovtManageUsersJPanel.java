...
public class GovtManageUsersJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 130, 638, -1));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 200, 638, 179));

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(25, 56, 82));
        jLabel6.setText("Organization");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 410, -1, -1));

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(25, 56, 82));
        jLabel3.setText("Employee");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 460, -1, -1));
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 550, -1, -1));

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(25, 56, 82));
        jLabel2.setText("Password");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 600, -1, -1));

        createUsername.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        createUsername.setForeground(new java.awt.Color(25, 56, 82));
        add(createUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 550, 260, -1));
        ...
        add(selectRole, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 500, 260, -1));
        ...
        add(selectEmployee, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 460, 260, -1));
        ...
        add(selectOrganization, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 410, 260, -1));
        ...
        add(createUserJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 660, 120, 30));

        createPassword.setFont(new java.awt.Font("SansSerif", 1, 13)); // NOI18N
        createPassword.setForeground(new java.awt.Color(25, 56, 82));
        add(createPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 600, 260, -1));
